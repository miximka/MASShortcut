...
- (void) testInitialValueReading
{
    ...
    NSData *archived = [NSKeyedArchiver archivedDataWithRootObject:shortcut requiringSecureCoding:true error:nil];
    [_defaults setObject:archived forKey:SampleDefaultsKey];
